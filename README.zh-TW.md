...
目前支援透過 [Gemini](https://deepmind.google/technologies/gemini/) 進行圖像生成與編輯、影片生成，Claude、OpenAI、Qwen 等供應商支援正在規劃中。

[繁體中文](./README.zh-TW.md) | [简体中文](./README.zh.md) | [English](./README.md)

<img src="./assets/logo.png" alt="yummycli logo" width="120" />

[安裝](#安裝) · [認證](#認證) · [圖像生成](#圖像生成) · [影片生成](#影片生成) · [Agent Skills](#agent-skills) · [命令參考](#命令參考)

---

## 為什麼選擇 yummycli？

- **Agent 原生設計** —— 開箱即用的結構化 [Skills](./skills/)，AI Agent 無需額外設定即可呼叫圖像與影片 API
- **能力優先架構** —— `image generate` 和 `video generate` 是穩定的自動化介面；`gemini nanobanana` 和 `gemini veo` 是其上層的人性化快捷方式
